...
let triangle (x1, y1) (x2, y2) (x3, y3) color =
  let rgba_list = to_rgba_list color in
  let pos_array = Js.array (Array.of_list (List.map Js.number_of_float [x1; y1; x2; y2; x3; y3])) in
  let color_array = Js.array (Array.of_list (List.map Js.number_of_float rgba_list)) in
  gen_prog [
...
let quad (x1, y1) (x2, y2) (x3, y3) (x4, y4) color =
  let rgba_list = to_rgba_list color in
  let pos_array = Js.array (Array.of_list (List.map Js.number_of_float [x1; y1; x2; y2; x3; y3; x4; y4])) in
  let color_array = Js.array (Array.of_list (List.map Js.number_of_float rgba_list)) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let rect_centered (x, y) (w, h) angle color =
  let rgba_list = to_rgba_list color in
  let posize_array = Js.array (Array.of_list (List.map Js.number_of_float [x; y; w; h])) in
  let color_array = Js.array (Array.of_list (List.map Js.number_of_float rgba_list)) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let poly xs color =
  ...
  let elem = List.concat_map (fun x -> [0.0; float_of_int x; float_of_int x +. 1.0]) 
    (List.init (List.length xs - 2) (fun i -> i + 1)) in
  let rgba_list = to_rgba_list color in
  let pos_array = Js.array (Array.of_list (List.map Js.number_of_float pos)) in
  let elem_array = Js.array (Array.of_list (List.map Js.number_of_float elem)) in
  let color_array = Js.array (Array.of_list (List.map Js.number_of_float rgba_list)) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let lines xs color =
  let pos = List.concat_map (fun ((x1, y1), (x2, y2)) -> [x1; y1; x2; y2]) xs in
...
let function_curve f (x, y) (left, right) freq color =
  ...
  let xs = List.init (samples + 1) (fun u -> 
    (float_of_int u /. float_of_int samples) *. (right -. left) +. left) in
...
let circle (x1, y1) r color =
  let rgba_list = to_rgba_list color in
  let cr_array = Js.array (Array.of_list (List.map Js.number_of_float [x1; y1; r])) in
  let color_array = Js.array (Array.of_list (List.map Js.number_of_float rgba_list)) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let rounded_rect (x1, y1) (w, h) r color =
  let rgba_list = to_rgba_list color in
  let cs_array = Js.array (Array.of_list (List.map Js.number_of_float [x1; y1; w; h])) in
  let color_array = Js.array (Array.of_list (List.map Js.number_of_float rgba_list)) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let texture_cropped (x1, y1) (x2, y2) (x3, y3) (x4, y4) (cx1, cy1) (cx2, cy2) (cx3, cy3) (cx4, cy4) name =
  let pos_array = Js.array (Array.of_list (List.map Js.number_of_float [x1; y1; x2; y2; x3; y3; x4; y4])) in
  let texc_array = Js.array (Array.of_list (List.map Js.number_of_float [cx1; cy1; cx2; cy2; cx3; cy3; cx4; cy4])) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let rect_texture_cropped (x, y) (w, h) (cx, cy) (cw, ch) name =
  let pos_array = Js.array (Array.of_list (List.map Js.number_of_float [x; y; x +. w; y; x +. w; y +. h; x; y +. h])) in
  let texc_array = Js.array (Array.of_list (List.map Js.number_of_float [cx; 1.0 -. cy; cx +. cw; 1.0 -. cy; cx +. cw; 1.0 -. cy -. ch; cx; 1.0 -. cy -. ch])) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
    ("_p", Js.Unsafe.inject (Js.string "textureCropped"));
    ("texture", Js.Unsafe.inject (Js.string name));
...
let centered_texture_cropped (x, y) (w, h) angle (cx, cy) (cw, ch) name =
  let posize_array = Js.array (Array.of_list (List.map Js.number_of_float [x; y; w; h])) in
  let texc_array = Js.array (Array.of_list (List.map Js.number_of_float [cx; cy; cw; ch])) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let texture_cropped_with_alpha (x1, y1) (x2, y2) (x3, y3) (x4, y4) (cx1, cy1) (cx2, cy2) (cx3, cy3) (cx4, cy4) alpha name =
  let pos_array = Js.array (Array.of_list (List.map Js.number_of_float [x1; y1; x2; y2; x3; y3; x4; y4])) in
  let texc_array = Js.array (Array.of_list (List.map Js.number_of_float [cx1; cy1; cx2; cy2; cx3; cy3; cx4; cy4])) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let rec rect_texture_with_alpha (x, y) (w, h) alpha name =
  centered_texture_with_alpha (x +. w /. 2.0, y +. h /. 2.0) (w, h) 0.0 alpha name
...
let centered_texture_cropped_with_alpha (x, y) (w, h) angle (cx, cy) (cw, ch) alpha name =
  let posize_array = Js.array (Array.of_list (List.map Js.number_of_float [x; y; w; h])) in
  let texc_array = Js.array (Array.of_list (List.map Js.number_of_float [cx; cy; cw; ch])) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let textbox (x, y) size text font color =
  let rgba_list = to_rgba_list color in
  let offset_array = Js.array (Array.of_list (List.map Js.number_of_float [x; y])) in
  let color_array = Js.array (Array.of_list (List.map Js.number_of_float rgba_list)) in
  gen_prog [
    ("_c", Js.Unsafe.inject (Js.number_of_float 0.0));
...
let textbox_pro (x, y) opt =
  ...
  gen_prog [
    ...
    ("valign", Js.Unsafe.inject (Js.string (get_with_default "top" opt.valign)));
    ("width", Js.Unsafe.inject (Js.number_of_float (get_with_default (-1.0) opt.width)));
    ("lineHeight", Js.Unsafe.inject (Js.number_of_float (get_with_default 1.0 opt.line_height)));
    ("wordSpacing", Js.Unsafe.inject (Js.number_of_float (get_with_default 1.0 opt.word_spacing)));
    ("letterSpacing", Js.Unsafe.inject (Js.number_of_float (get_with_default 0.0 opt.letter_spacing)));
    ("tabSize", Js.Unsafe.inject (Js.number_of_float (get_with_default 4.0 opt.tab_size)));
    ("thickness", Js.Unsafe.inject (Js.number_of_float (get_with_default 0.0 opt.thickness)));
    ("it", Js.Unsafe.inject (Js.number_of_float (get_with_default 0.0 opt.italic)))
  ]
