...
val triangle :
  float * float -> float * float -> float * float -> Color.t -> renderable
...
val rect_centered :
  float * float -> float * float -> float -> Color.t -> renderable
...
val poly_prim :
  (float * float) list -> float list -> Color.t -> primitive -> renderable
...
val centered_texture :
  float * float -> float * float -> float -> string -> renderable

val centered_texture_cropped :
  float * float ->
  float * float ->
  float ->
  float * float ->
...
val texture_cropped_with_alpha :
  float * float ->
  float * float ->
  float * float ->
  float * float ->
...
val rect_texture_with_alpha :
  float * float -> float * float -> float -> string -> renderable

val rect_texture_cropped_with_alpha :
  float * float ->
  float * float ->
  float * float ->
  float * float ->
...
val centered_texture_with_alpha :
  float * float -> float * float -> float -> float -> string -> renderable

val centered_texture_cropped_with_alpha :
  float * float ->
  float * float ->
  float ->
  float * float ->
...
val textbox :
  float * float -> float -> string -> string -> Color.t -> renderable

val textbox_mf :
  float * float -> float -> string -> string list -> Color.t -> renderable

val textbox_centered :
  float * float -> float -> string -> string -> Color.t -> renderable

val textbox_mf_centered :
  float * float -> float -> string -> string list -> Color.t -> renderable
